...
class theme_boost_union_child_block_myoverview_renderer extends \block_myoverview\output\renderer {
    /**
    ...
    public function render_main($main) {
        $con = get_config('theme_boost_union_child', 'monthtoswitchyearfilter');
